...
* **Обязанности**:
    ...
    Модернизация и доработка административной панели для администраторов-менеджеров - управление платежами (вовзраты,
    ...
    администраторов-менеджеров, только с большей статистекой и без прав администрирования.
    ...
    * iFrame оплаты для интеграции на стороне клиента.
    ...
    Сопровождение и поддержка клиентов, партнеров компании. Помощь в итеграции к системе интегратора платежных систем.
    Реализация автоматических отчетов для взаиморасчета с клиентов, упрощение для работы бухгалтерии.
    
    Возглавил команду из 4 программистов, помощь в постановке задач, принятие архитиктурных решений и 
...
* **Проекты**:
    ...
    Казахстан:
    * Обновлял и модернезировал интеграция с банком Epay AO «Qazkom» 
    ...
    * Создал интеграцию экваринга для АО «Банк Русский Стандарт» 
...
* **Обязанности**: 
    ...
    Создавалась админка для статистики, модерации, администрирования и и прочих сопутствующих web-интерфейсов.
